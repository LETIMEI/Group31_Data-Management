---
title: "Data Management Group_31 Report"
format: 
  pdf:
    toc: true
    toc-depth: 3
...
![](images/E-R%20Diagram%20First%20Version.png){width="571"}

##### Figure 2: Our Final E-R diagram

![](images/E-R%20Diagram.png){width="571"}

Our final diagram contains 6 main entities and their attributes. Seven 1 to N relationships, one M to N relationship between Product and Customer and 2 self referencing relationships(referred and belongs). The key attributes (unique) of each entity are underlined.
...
![](images/Add%20plot%20figure.png)

![](images/Add%20plot%20figure2.png)
